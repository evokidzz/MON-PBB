            ...
            ?>
              ...
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a href="?page=edit-kematian&kode=<?php echo $data['no_surat']; ?>" title="Ubah" class="btn btn-info btn-sm">
                    <i class="fa fa-edit"></i>
                  </a>
                  <a href="?page=del-kematian&kode=<?php echo $data['no_surat']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
                    <i class="fa fa-trash"></i>
                  </a>
                  <a href="admin\cetak\kematian\contoh_surat_kematian.php?no_surat=<?= $data['no_surat'] ?>" target="_blank" title="Cetak" class="btn btn-success btn-sm">
