...
if (isset($_GET['kode'])) {
    $sql_cek = "SELECT * FROM tb_betul WHERE id_betul='" . $_GET['kode'] . "'";
...
<div class="card card-dark">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-edit"></i> Ubah Data Berkas Pembetulan
        </h3>
    </div>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="card-body">

            <input type='hidden' class="form-control" name="id_betul" value="<?php echo $data_cek['id_betul']; ?>" readonly />
...
if (isset($_POST['Ubah'])) {
    ...
    if ($query_ubah) {
      ...
      Swal.fire({title: 'Ubah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
        ...
        {window.location = 'index.php?page=data-betul';
        }
      })</script>";
    } else {
        echo "<script>
