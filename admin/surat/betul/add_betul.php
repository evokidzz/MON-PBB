<div class="card card-dark">
  <div class="card-header">
    <h3 class="card-title">
      <i class="fa fa-edit"></i> Tambah Data Berkas Pembetulan
    </h3>
  </div>
...
if (isset($_POST['Simpan'])) {
  ...
  $sql_simpan = "INSERT INTO tb_betul (no_pel,tgl_pel,nop,nik,nama,alamat,letak_op,kel,kec,ket) VALUES (
    '" . $_POST['no_pel'] . "',
    '" . $_POST['tgl_pel'] . "',
    '" . $_POST['nop'] . "',
    '" . $_POST['nik'] . "',
  ...
  if ($query_simpan) {
    ...
    echo "<script>
		  Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
			  ...
			  window.location = 'index.php?page=add-betul';
			  }
