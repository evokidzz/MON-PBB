<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label" for="almt_sementara">ALAMAT SEMENTARA</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="almt_sementara" name="almt_sementara" placeholder="ALAMAT SEMENTARA" required>
				</div>
			</div>
...
if (isset($_POST['Simpan'])) {
	...
	$sql_simpan = "INSERT INTO tb_domisili (no_surat,tgl_pengajuan,nik,nama,almt_sementara,keperluan,masa_berlaku) VALUES (
		
		'" . $_POST['no_surat'] . "',
        '" . $_POST['tgl_pengajuan'] . "',
        '" . $_POST['nik'] . "',
        '" . $_POST['nama'] . "',
        '" . $_POST['almt_sementara'] . "',
		'" . $_POST['keperluan'] . "',		
        '" . $_POST['masa_berlaku'] . "')";
