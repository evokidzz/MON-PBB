...
include "../../../inc/koneksi.php";
$query    = mysqli_query($koneksi, "SELECT * FROM tb_betul WHERE id_betul='$id_berkas'");
...
<head>
    <title>TANDA TERIMA PEMBETULAN</title>
...
<body>
    <center>
        ...
        <table>
            <strong style="font-size: 20px;"><b><u>TANDA TERIMA PEMBETULAN</u></b></strong>
