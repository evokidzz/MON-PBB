...
include "../../../inc/koneksi.php";
$query    = mysqli_query($koneksi, "SELECT * FROM tb_kematian WHERE no_surat='$no_surat'");
...
<body>
	<center>
		...
		<table>
			...
			<center>
				<strong style="font-size: 20px;"><b><u>SURAT KETERANGAN KEMATIAN</u></b></strong>
			</center>
			<center>
		...
		<table width="350">
			...
			<tr>
				<td>
					<font size="3">Meninggal Pada</font>
				</td>
				<td>
					<font size="3">: <?php echo $data['tgl_meninggal']; ?></font>
				</td>
			</tr>
			<tr>
				<td>
					<font size="3">Pukul</font>
				</td>
				<td width="350">
					<font size="3">: <?php echo $data['jam']; ?></font>
				</td>
			</tr>
		</table>
		<table width="550">
			<tr>
				<td align="justify">
					<font size="3">Orang tersebut di atas adalah benar penduduk Desa Nusa Indah yang telah meninggal dunia.</font>
				</td>
			</tr>
		</table>
		<table width="550">
			<tr>
				<td align="justify">
					<font size="3">Demikian Surat Keterangan Kematian ini dibuat dengan sebenarnya, dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.</font>
				</td>
			</tr>
		</table>
		<br>
