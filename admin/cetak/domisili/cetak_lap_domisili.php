...
$pdf->Text(90, 52, 'LAPORAN REKAP SURAT KETERANGAN DOMISILI');
...
$pdf->CELL(40, 6, 'ALAMAT SEMENTARA', 1, 0, 'C', 1);
...
while ($data = mysqli_fetch_array($sql)) {
    ...
    $pdf->CELL(40, 6, $data['almt_sementara'], 1, 0, 'C', 1);
