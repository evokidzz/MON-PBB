...
$pdf->CELL(27, 6, 'NAMA', 1, 0, 'C', 1);
$pdf->CELL(23, 6, 'TEMPAT LAHIR', 1, 0, 'C', 1);
$pdf->CELL(25, 6, 'TANGGAL LAHIR', 1, 0, 'C', 1);
$pdf->CELL(25, 6, 'JENIS KELAMIN', 1, 0, 'C', 1);
$pdf->CELL(30, 6, 'ALAMAT', 1, 0, 'C', 1);
$pdf->CELL(20, 6, 'AGAMA', 1, 0, 'C', 1);
$pdf->CELL(28, 6, 'STATUS', 1, 0, 'C', 1);
$pdf->CELL(32, 6, 'PEKERJAAN', 1, 0, 'C', 1);
...
while ($data = mysqli_fetch_array($sql)) {
    ...
    $pdf->CELL(23, 6, $data['tmpt_lahir'], 1, 0, 'C', 1);
    $pdf->CELL(25, 6, $data['tgl_lahir'], 1, 0, 'C', 1);
    $pdf->CELL(25, 6, $data['jenis_kelamin'], 1, 0, 'C', 1);
    $pdf->CELL(30, 6, $data['alamat'], 1, 0, 'C', 1);
    $pdf->CELL(20, 6, $data['agama'], 1, 0, 'C', 1);
    $pdf->CELL(28, 6, $data['status'], 1, 0, 'C', 1);
    $pdf->CELL(32, 6, $data['pekerjaan'], 1, 0, 'C', 1);
    $ya = $ya + $row;
    $no++;
}
...
$pdf->AliasNbPages();
ob_clean();
$pdf->Output('D', 'Data Penduduk.PDF');
