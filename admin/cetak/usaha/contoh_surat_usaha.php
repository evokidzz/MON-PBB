...
include "../../../inc/koneksi.php";
$query    = mysqli_query($koneksi, "SELECT * FROM tb_usaha WHERE no_surat='$no_surat'");
...
<body>
	<center>
		...
		<table>
			...
			<center>
				<strong style="font-size: 20px;"><b><u>SURAT KETERANGAN USAHA</u></b></strong>
			</center>
			<center>
		...
		<table width="350">
			...
			<table width="550">
				<tr>
					<td align="justify">
						<font size="3">Bahwa Orang tersebut diatas adalah benar mempunyai Usaha yaitu :</font>
					</td>
				</tr>
			</table>
			<table width="350">
				<tr>
					<td width="100">
						<font size="3">Jenis Usaha</font>
					</td>
					<td>
						<font size="3">: <?php echo $data['jns_usaha']; ?></font>
					</td>
				</tr>
				<tr>
					<td>
						<font size="3">Alamat Usaha</font>
					</td>
					<td>
						<font size="3">: <?php echo $data['almt_usaha']; ?></font>
					</td>
				</tr>
		...
		<table width="550">
			<tr>
				<td align="justify">
					<font size="3">Demikian Surat Keterangan ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.</font>
				</td>
			</tr>
		</table>
		<br>
