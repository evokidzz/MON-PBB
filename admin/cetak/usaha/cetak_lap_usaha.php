...
$pdf->Text(80, 52, 'LAPORAN REKAP SURAT KETERANGAN USAHA');
...
$pdf->CELL(40, 6, 'PEKERJAAN', 1, 0, 'C', 1);
$pdf->CELL(35, 6, 'JENIS USAHA', 1, 0, 'C', 1);
$pdf->CELL(55, 6, 'ALAMAT USAHA', 1, 0, 'C', 1);

$query = "select * from tb_usaha";
...
while ($data = mysqli_fetch_array($sql)) {
    ...
    $pdf->CELL(40, 6, $data['pekerjaan'], 1, 0, 'C', 1);
    $pdf->CELL(35, 6, $data['jns_usaha'], 1, 0, 'C', 1);
    $pdf->CELL(55, 6, $data['almt_usaha'], 1, 0, 'C', 1);
    $ya = $ya + $row;
    $no++;
}
