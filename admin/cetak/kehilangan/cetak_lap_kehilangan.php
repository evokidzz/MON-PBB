...
$pdf->Text(80, 52, 'LAPORAN REKAP SURAT KETERANGAN KEHILANGAN');
...
$pdf->CELL(30, 6, 'PEKERJAAN', 1, 0, 'C', 1);
$pdf->CELL(30, 6, 'TGL.KEHILANGAN', 1, 0, 'C', 1);
$pdf->CELL(30, 6, 'TMPT.KEHILANGAN', 1, 0, 'C', 1);
$pdf->CELL(30, 6, 'KETERANGAN', 1, 0, 'C', 1);

$query = "select * from tb_kehilangan";
...
while ($data = mysqli_fetch_array($sql)) {
    ...
    $pdf->CELL(30, 6, $data['pekerjaan'], 1, 0, 'C', 1);
    $pdf->CELL(30, 6, $data['tgl_kehilangan'], 1, 0, 'C', 1);
    $pdf->CELL(30, 6, $data['tmpt_kehilangan'], 1, 0, 'C', 1);
...
$pdf->AliasNbPages();
ob_clean();
$pdf->Output('D', 'Ket.Kehilangan.PDF');
